    ...
    return (
        <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-950' : 'bg-gray-50'} p-6`}>
            ...
            <footer className="mt-10 text-center text-sm text-gray-500">
                <p>Made with ❤️ by Satyam Jadhav | <a href="mailto:satyam2373@gmail.com" className="text-blue-500 hover:underline">satyam2373@gmail.com</a></p>
                ...
                <p className="mt-2">Made with <span className="font-bold">lovable.ai</span>. Feel free to contribute!</p>
            </footer>
        </div>
    );
};
